...
class Lesson:
    def __init__(self, cfg_dict):
        ...
        self.cards = self.dict.get_lesson_cards()
        en_ru_percent = 0
        ru_en_percent = 0
        for c in self.cards:
            en_ru_percent += c.statistic['en-ru'].percent
            ru_en_percent += c.statistic['ru-en'].percent
        self.direction = 'en-ru' if en_ru_percent <= ru_en_percent else 'ru-en'
        d = self.direction
